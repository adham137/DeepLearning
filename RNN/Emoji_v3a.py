...
X_my_sentences = np.array(["lets go to the sports event", "i love you", "funny lol", "lets play with a ball", "food is ready", "not feeling happy"])
...
x_test = np.array(['I hate you, when you play sports'])
X_test_indices = sentences_to_indices(x_test, word_to_index, maxLen)
